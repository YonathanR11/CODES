...
require_once "conexion.php";
  ...
  codigos.usuarios_id=us.id AND lenguaje = 'linux';";
    foreach (Conexion::conectar()->query($sql) as $row) {
        ...
        <div class="card-body">
          ...
          <span class="badge" style="background: black; color: #2CF334">'.$row['lenguaje'].'</span>
          <span class="badge badge-dark">'.date_format($date, 'd/m/Y').'</span>
          <pre class="language-batch line-numbers"><code>'.str_replace("<", "&lt;", $row["codigo"]).'</code></pre>';
