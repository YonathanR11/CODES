          ...
          echo '<div class="card m-3">
            <div class="card-body">
              ...
              if (isset($_SESSION['usuario']) && $row['usuario'] == $_SESSION['usuario']) {
                echo '<button type="button" class="btn btn-warning btn-sm btn-sm EditarCode" idCode='.$row["idCode"].' data-toggle="modal" data-target="#ModalEditar"  data-controls-modal="ModalEditar" data-backdrop="static" data-keyboard="false">Editar</button>';
