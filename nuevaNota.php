...
if (isset($_POST['titulo'])) {
    ...
    $stmt = Conexion::conectar()->prepare("INSERT INTO codigos (titulo, descripcion, codigo, lenguaje, estado, usuarios_id) 
        VALUES (:titulo, :descripcion, :codigo, :lenguaje, :estado, :usuarios_id)");
